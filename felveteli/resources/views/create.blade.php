...
@section('content')
    <div class="container-fluid pt-4 px-4">
        <form action="{{route('store')}}" method="post" id="createForm" enctype="multipart/form-data">
            @csrf
            <div class="bg-light rounded h-100 p-4">
                ...
                <div>
                    ...
                    <div class="form-floating mb-3">
                        <div class="col-md-3 mx-left">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Stark Industries" value="{{old('name')}}">
                ...
                <div>
                    ...
                    <div class="form-floating mb-3">
                        <div class="col-md-3 mx-left">
                            <input type="number" name="taxNumber" id="taxNumber" class="form-control" placeholder="*number*" value="{{old('taxNumber')}}">
                ...
                <div>
                    ...
                    <div class="form-floating mb-3">
                        <div class="col-md-3 mx-left">
                            <input type="email" name="email" id="email" class="form-control" placeholder="example@example.com" value="{{old('email')}}">
                ...
                <div>
                    ...
                    <div class="form-floating mb-3">
                        <div class="col-md-3 mx-left">
                            <input type="tel" name="phoneNumber" id="phoneNumber" class="form-control" placeholder="+58245852565" value="{{old('phoneNumber')}}">
